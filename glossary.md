...
| Data Collab (DX)         | Provides domain specific training and inference capabilities which includes aggregates, validates, curates data from multiple providers and governs access.         | HealthyLife Data Collective provisions curated fitness datasets to HealthModels. Oncology or biopharma data collectives will enable domain rich DEPA ecosystem players. |
